        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <li class="">
                <a href="/ts-admin">
                    ...
                    <span>داشبرد</span><span class="pull-right-container"></span>
                </a>
            </li>
            <li class="treeview">
                <a href="#">
              ...
              <i class="fa fa-angle-right pull-right"></i>
                ...
                <ul class="treeview-menu">
                    ...
                    <li><a href="{{route('categories.create')}}"><i class="mdi mdi-toggle-switch-off"></i>افزودن دسته بندی جدید</a></li>
                </ul>
            </li>
            <li class="treeview">
                <a href="#">
              ...
              <i class="fa fa-angle-right pull-right"></i>
                ...
                <ul class="treeview-menu">
                    <li><a href="pages/extension_fullscreen.html"><i
                                class="mdi mdi-toggle-switch-off"></i>Fullscreen</a>
                    </li>
