...
<head>
    ...
    <!-- Bootstrap 4.0-->
    <link rel="stylesheet" href="/admin/plugins/vendor_components/bootstrap/dist/css/bootstrap.css">
    ...
    <!-- daterange picker -->
    <link rel="stylesheet" href="/admin/plugins/vendor_components/bootstrap-daterangepicker/daterangepicker.css">

    <!-- Morris charts -->
    <link rel="stylesheet" href="/admin/plugins/vendor_components/morris.js/morris.css">

    <!-- Data Table-->
    <link rel="stylesheet" type="text/css" href="/admin/plugins/vendor_components/datatable/datatables.min.css"/>
...
<!-- jQuery 3 -->
<script src="/admin/plugins/vendor_components/jquery-3.3.1/jquery-3.3.1.js"></script>

<!-- jQuery UI 1.11.4 -->
<script src="/admin/plugins/vendor_components/jquery-ui/jquery-ui.js"></script>
...
<!-- popper -->
<script src="/admin/plugins/vendor_components/popper/dist/popper.min.js"></script>

<!-- date-range-picker -->
<script src="/admin/plugins/vendor_components/moment/min/moment.min.js"></script>
<script src="/admin/plugins/vendor_components/bootstrap-daterangepicker/daterangepicker.js"></script>

<!-- Bootstrap 4.0-->
<script src="/admin/plugins/vendor_components/bootstrap/dist/js/bootstrap.js"></script>

<!-- ChartJS -->
<script src="/admin/plugins/vendor_components/chart.js-master/Chart.min.js"></script>

<!-- Slimscroll -->
<script src="/admin/plugins/vendor_components/jquery-slimscroll/jquery.slimscroll.js"></script>

<!-- FastClick -->
<script src="/admin/plugins/vendor_components/fastclick/lib/fastclick.js"></script>

<!-- Morris.js charts -->
<script src="/admin/plugins/vendor_components/raphael/raphael.min.js"></script>
<script src="/admin/plugins/vendor_components/morris.js/morris.min.js"></script>

<!-- This is data table -->
<script src="/admin/plugins/vendor_components/datatable/datatables.min.js"></script>
